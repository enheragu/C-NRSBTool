...
const I18n = (() => {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      chart_modal_help:    'Inside the chart: wheel = zoom, click+drag = pan, double click = reset, Esc = close.',
    ...
    es: {
      ...
      intro_title:         'Sobre esta herramienta',
      ...
      chart_modal_help:    'Dentro del gráfico: rueda = zoom, clic+arrastrar = mover, doble clic = reset, Esc = cerrar.',
